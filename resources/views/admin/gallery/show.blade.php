        ...
        <div class="col-md-10">
            <div class="box box-widget">
                <div class="box-header with-border">
                    ...
                    @switch($data->tags)
                      @case(1)
                        <h2><a href="#" class="description">Makanan</a></h2>
                      @break
                      @case(2)
                        <h2><a href="#" class="description">Minuman</a></h2>                                
                      @break
                      @case(1)
                        <h2><a href="#" class="description">Kue Tradisional</a></h2>                                
                      @break
                      @default
                        <h2><a href="#" class="description">Uncategorized</a></h2>                                            
                      @endswitch
                    <h3><small>{{$data->price}}</small></h3>       
                </div>
                <div class="box-body row">
                    <div class="productImage col-md-4">
                      <img src="{{ url('image/product/'.$data->image->image) }}" alt="productImage" class="img-thumbnail">
                    </div>
                    <div class="productDesc col-md-12">
                      {{$data->desc}}
                    </div>
                </div>
                <div class="box-tools">
                    <a href="{{ route('admin.product.edit', $data->id)}}" class="btn btn-danger">Delete</a>
