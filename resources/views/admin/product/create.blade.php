                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            @error('desc')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            <textarea class="form-control" rows="3" placeholder="Product Description" name="desc"></textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" min=0 placeholder="Harga" name="price" >
                            </div>
                        </div>
                        <div class="form-group">
