    ...
    <section class="content container-fluid d-flex justify-content-center">
        @if (!isset($data))
          <div class="col-md-2 align-middle h-200">
            <a href="{{ route('admin.footer.create')}}" class="btn btn-lg btn-primary">Add Footer</a>
          </div>
        @else
        <table class="table">
            <tbody>
              <tr>
                ...
                <tr>
                    ...
                    <td>{{ $data->footerAddress }}</td>
                    <td>{{ $data->footerEmail }}</td>
                    <td>{{ $data->footerPhone }}</td>
                    <td>{{ $data->facebookLink }}</td>
                    <td>{{ $data->twitterLink }}</td>
                    <td>{{ $data->instagramLink }}</td>
                    <td><a href="{{ route('admin.footer.edit',$data->id) }}" class="btn btn-info">Edit</a></td>
                </tr>
            </tbody>
          </table>
        @endif
