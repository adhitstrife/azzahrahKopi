        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item active">
                  <a class="nav-link" href="{{ route('front.product.page') }}">Product <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <div class="filter row">
        <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="{{route('front.product.page',['tags'=>1])}}">Makanan</a>
                <a class="dropdown-item" href="{{route('front.product.page',['tags'=>2])}}">Minuman</a>
                <a class="dropdown-item" href="{{route('front.product.page',['tags'=>3])}}">Kue Tradisional</a>
            </div>
        </div>     
    </div>
    <div class="product-contents row justify-content-around">
